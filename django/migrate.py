import sys
import os
from redington_uber.settings import PROJECT_APPS
...
def migrate():
    ...
    status = os.system('python3 manage.py makemigrations cloudapp %s' % ' '.join(apps_formatted))
...
if __name__ == "__main__":
    ...
    if sys.argv.__len__() == 1:
        ...
        if command == 'updateroles':
            import django
            os.environ.setdefault("DJANGO_SETTINGS_MODULE", "redington_uber.settings")
            django.setup()
