...
class Command(BaseCommand):
    help = "This command migrates from old Redington cloud to new system"
    ...
    def handle(self, *args, **options):
        ...
        with open(os.path.join(migration_csvs, 'partners.csv'), 'r', encoding='latin1') as csvfile:
        ...
        with open(os.path.join(migration_csvs, 'customers.csv'), 'r', encoding='latin1') as csvfile:
            reader = csv.reader(csvfile)
            for row in reader:
                customer = Customers()
        ...
        with open(os.path.join(migration_csvs, 'users.csv'), 'r', encoding='latin1') as csvfile:
            reader = csv.reader(csvfile)
            for row in reader:
                ...
                UserProfile.objects.create(
                    ...
                    created_by = RedUser.objects.get(username='admin'),
                    role_id = 2
                )